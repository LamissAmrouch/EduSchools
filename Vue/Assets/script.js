...
NouveauInput.id ="style_input";
var arrayLignes = document.getElementById("monTableau").rows;
var longueur = arrayLignes.length;
alert(longueur);
var arrayCellules = arrayLignes[pos].cells;
//arrayCellules[0].replaceWith(NouveauInput);
var parent = arrayCellules[0].parentNode;
parent.replaceChild(NouveauInput,arrayCellules[0]);*/

//var type_form = $(".type_formation:eq("+ pos +")").text();
//alert(type_form);
