...
<li class="menu"> <a class="menu-lien" href="universitaire.php"> Universitaire</a></li>
...
<li class="menu"> <a class="menu-lien" href="Gestion-ecoles.php"> Gestion des écoles</a></li>
...
<section>
<div id="div1" > <a class="lien" href="universitaire.php"> Universitaire <a/> </div>
