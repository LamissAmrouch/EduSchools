...
require_once('../Modele/EcoleManager.php');
    ...
    $informations = $ecoleMng->GetEcoleInfomation(1);
...
echo '<tr class="tt">';
  ...
  echo '<td> <a href="site-ecole.php" class="lien"> '.$resultat['nom'].'</a></td>'; 
  echo '<td> Universitaire </td>';
  echo '<td>'.$resultat['domaine'].'</td>';
  ...
  echo '<td> <a href="page-commentaire.php"> Commenter </a></td>';
  echo '<td> <a href="Gestion-site.php"> Gérer le site </a></td>';
  echo '</tr>';
